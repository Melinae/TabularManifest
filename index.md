...
The idea behind this [R](https://www.r-project.org/) package is that
*configuring* metadata is quicker and more robust than *coding* the same
repetitive code.
...
starting material described in the `documentation-for-developers/`
directory.
...
Melinae, please contact [Jim
Quallen](https://www.linkedin.com/in/jim-quallen/) at <jim@melinae.com>.
If you have a question about the package, please consider [starting a
new issue](https://github.com/Melinae/TabularManifest/issues/new).
